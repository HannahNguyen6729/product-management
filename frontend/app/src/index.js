...
const handleEdit = async (id) => {
  ...
  document.getElementById("class").value = student.price;
  document.getElementById("age").value = student.amount;
  document.getElementById("discount").value = student.sale;
...
document.getElementById("addStudent").addEventListener("click", async () => {
  ...
  const amount = +document.getElementById("class").value;
  const price = +document.getElementById("age").value;
  const sale = +document.getElementById("discount").value;
  const student = {
    name,
    amount,
    price,
...
document.getElementById("updateStudent").addEventListener("click", async () => {
  ...
  await updateStudent(id, product);
